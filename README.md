...
│   ├── generate_candidates.py   # Synthetic candidate generation + labeling
│   ├── check_requirement7.py    # JD Requirement 7 verification
│   └── train_model.py           # Model training and evaluation
├── data/
│   ├── filtered_jobs.csv        # 2,553 filtered European AI/Data/PM postings
│   ├── labeled_candidates.csv   # 250 synthetic candidates + Fit_Label
│   └── sample_upload*.csv       # Demo upload files (30/150/250/600)
├── models/
